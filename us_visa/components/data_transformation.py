...
from us_visa.entity.artifact_entity import DataTransformationArtifact, DataIngestionReturnType, DataValidationReturnType
...
class DataTransformation:
    def __init__(self, data_ingestion_artifact: DataIngestionReturnType,
