...
from us_visa.entity.artifact_entity import ModelTrainerArtifact, DataIngestionReturnType, ModelEvaluationArtifact
...
class ModelEvaluation:
    ...
    def __init__(self, model_eval_config: ModelEvaluationConfig, data_ingestion_artifact: DataIngestionReturnType,
